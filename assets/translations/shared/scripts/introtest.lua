...
makeLuaSprite('3', 'pt-BR/ha1', screenWidth / 1.7 - 369, screenHeight / 1.8 - 185);
...
makeLuaSprite('ready', 'pt-BR/ha2', screenWidth / 1.7 - 369, screenHeight / 1.8 - 185);
...
makeLuaSprite('set', 'pt-BR/ha3', screenWidth / 1.7 - 369, screenHeight / 1.8 - 185);
...
makeLuaSprite('GO', 'pt-BR/one', screenWidth / 1.5 - 569, screenHeight / 1.8 - 185);
